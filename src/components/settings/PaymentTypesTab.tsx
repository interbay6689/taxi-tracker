...
import { Trash2, Plus, Edit, Bitcoin } from 'lucide-react';
import { useCustomPaymentTypes, CustomPaymentType } from '@/hooks/useCustomPaymentTypes';
import { CryptoPaymentInterface } from '@/components/CryptoPaymentInterface';
...
export const PaymentTypesTab = () => {
  ...
  return (
    <Tabs defaultValue="custom-types" className="space-y-4">
      <TabsList className="grid w-full grid-cols-2">
        <TabsTrigger value="custom-types" className="flex items-center gap-2">
      ...
      <TabsContent value="custom-types">
        ...
        <div className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                קבל תשלומים במטבעות קריפטוגרפיים - דמו לצורך הדגמה
              </CardDescription>
            </CardHeader>
            <CardContent>
              <CryptoPaymentInterface 
                tripAmount={50} 
                onPaymentComplete={(txHash, cryptoType) => {
                  console.log('Crypto payment completed:', { txHash, cryptoType });
                }}
              />
            </CardContent>
          </Card>
